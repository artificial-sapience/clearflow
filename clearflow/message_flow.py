...
class _MessageFlowBuilderContext[TStartMessage: Message, TCurrentMessage: Message]:
    ...
    def end(self, message_type: type[TCurrentMessage]) -> _MessageFlow[TStartMessage, TCurrentMessage]:
        ...
        return cast("_MessageFlow[TStartMessage, TCurrentMessage]", result)
...
class _MessageFlowBuilder[TStartMessage: Message, TCurrentMessage: Message]:
    ...
    def add_termination(
        ...
        from_node_name: str,
        message_type: type[Message],
    ) -> _MessageFlow[TStartMessage, Message]:
