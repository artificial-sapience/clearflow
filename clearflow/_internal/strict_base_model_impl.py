...
class StrictBaseModel(BaseModel):
    ...
    - arbitrary_types_allowed=True: Allow abstract types like _NodeInterface
    ...
    model_config = ConfigDict(
        ...
        # --- Type validation ---
        arbitrary_types_allowed=True,  # Allow _NodeInterface and other abstract types
        # Required for fields typed with pure ABC interfaces
        # Still maintains safety through explicit type annotations
