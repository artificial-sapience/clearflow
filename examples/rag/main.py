...
def _print_query_instructions() -> None:
    ...
    print("\nExample questions researchers might ask:")
    print("  • What are PFAS chemicals and why are they dangerous?")
    print("  • How does HI-271 compare to traditional remediation methods?")
    print("  • What were the results at the Michigan test site?")
    print("  • How much does mycelium remediation cost per ton?")
    print("  • What's the optimal pH range for HI-271 deployment?")
    print("  • How long does complete PFAS remediation take?")
