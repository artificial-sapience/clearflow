...
class RiskMetrics:
    ...
    concentration_risk: Mapping[str, float] = Field(description="Risk concentration by sector/asset")
...
class RiskAssessment:
    ...
    stress_test_results: Mapping[str, float] = Field(description="Scenario analysis outcomes")
