...
For the complete MVP design, implementation approach, and architectural decisions, see **[stigmergic-mvp-design.md](./stigmergic-mvp-design.md)**.

The MVP focuses on:
- **LLM-first architecture**: Agents as proxies for LLM intelligence
- **Semantic relevance**: Not physical attraction metaphors
- **Small-scale optimization**: 10-100 signals, in-memory, ephemeral sessions
- **Simplicity over complexity**: Brute-force LLM evaluation instead of algorithms
